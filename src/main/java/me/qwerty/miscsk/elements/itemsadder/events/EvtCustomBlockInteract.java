...
public class EvtCustomBlockInteract extends SkriptEvent {
    ...
    static {
        Skript.registerEvent("ItemsAdder block interact",
                EvtCustomBlockInteract.class,
                CustomBlockInteractEvent.class,
    ...
    public boolean check(Event e) {
        if (blocksId != null) {
            String customblock = ((CustomBlockInteractEvent) e).getNamespacedID();
    ...
    public String toString(@Nullable Event e, boolean debug) {
        return "Items Adder custom block interact " + blocksId.toString(e, debug);
    }
}
