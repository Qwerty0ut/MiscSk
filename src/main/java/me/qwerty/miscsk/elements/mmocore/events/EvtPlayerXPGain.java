...
public class EvtPlayerXPGain extends SkriptEvent {
    ...
    static {
        ...
        EventValues.registerEventValue(PlayerExperienceGainEvent.class, EXPSource.class,
                new Getter<EXPSource, PlayerExperienceGainEvent>() {
                    @Override
                    public @Nullable EXPSource get(PlayerExperienceGainEvent arg) {
